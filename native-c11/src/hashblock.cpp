...
jbyteArray JNICALL hashC11_native(JNIEnv *env, jclass cls, jbyteArray header)
{
	...
	uint256 result = HashC11(P, P+Plen);
...
static const JNINativeMethod methods[] = {
    { "c11_native", "([B)[B", (void *) hashC11_native }
};
...
jint JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    jclass cls = (env)->FindClass("com/hashengineering/crypto/C11");
